...
if ($type !== 'all' && array_key_exists($type, $data)) {
    jsonResponse(['success' => true, 'data' => $data[$type]]);
}
...
function getDemoData(): array
{
    return [
        ...
        'projects' => [
            [ 'project_id' => 1, 'name' => 'E-Commerce Platform', 'description' => 'Build a new e-commerce platform with React and Node.js', 'status' => 'in progress', 'priority' => 'high', 'start_date' => '2026-02-01', 'deadline' => '2026-06-30', 'created_by' => 1, 'created_at' => '2026-01-15T10:00:00Z' ],
            [ 'project_id' => 2, 'name' => 'Mobile App Development', 'description' => 'Create a mobile app for iOS and Android', 'status' => 'in progress', 'priority' => 'medium', 'start_date' => '2026-03-01', 'deadline' => '2026-08-31', 'created_by' => 1, 'created_at' => '2026-02-20T10:00:00Z' ],
            [ 'project_id' => 3, 'name' => 'Data Analytics Dashboard', 'description' => 'Build an analytics dashboard for business intelligence', 'status' => 'new', 'priority' => 'low', 'start_date' => '2026-05-01', 'deadline' => '2026-10-31', 'created_by' => 1, 'created_at' => '2026-04-10T10:00:00Z' ],
        ],
        'project_members' => [
        ...
        'tasks' => [
            [ 'task_id' => 1, 'project_id' => 1, 'assigned_to' => 4, 'created_by' => 2, 'task_name' => 'Setup Project Structure', 'description' => 'Initialize the project with React, TypeScript, and Tailwind', 'status' => 'done', 'priority' => 'high', 'start_date' => '2026-02-01', 'deadline' => '2026-02-05T17:00:00Z', 'created_at' => '2026-01-16T10:00:00Z' ],
            [ 'task_id' => 2, 'project_id' => 1, 'assigned_to' => 5, 'created_by' => 2, 'task_name' => 'Design Database Schema', 'description' => 'Create the database schema for products, users, and orders', 'status' => 'done', 'priority' => 'high', 'start_date' => '2026-02-01', 'deadline' => '2026-02-10T17:00:00Z', 'created_at' => '2026-01-16T11:00:00Z' ],
            [ 'task_id' => 3, 'project_id' => 1, 'assigned_to' => 4, 'created_by' => 2, 'task_name' => 'Implement Authentication', 'description' => 'Build user authentication with JWT tokens', 'status' => 'in progress', 'priority' => 'high', 'start_date' => '2026-02-06', 'deadline' => '2026-02-20T17:00:00Z', 'created_at' => '2026-02-05T10:00:00Z' ],
            [ 'task_id' => 4, 'project_id' => 1, 'assigned_to' => 5, 'created_by' => 2, 'task_name' => 'Create Product Catalog UI', 'description' => 'Design and implement the product catalog interface', 'status' => 'review', 'priority' => 'medium', 'start_date' => '2026-02-15', 'deadline' => '2026-03-15T17:00:00Z', 'created_at' => '2026-02-12T10:00:00Z' ],
            [ 'task_id' => 5, 'project_id' => 2, 'assigned_to' => 6, 'created_by' => 3, 'task_name' => 'Mobile UI Wireframes', 'description' => 'Create wireframes for all mobile screens', 'status' => 'new', 'priority' => 'high', 'start_date' => '2026-03-01', 'deadline' => '2026-03-15T17:00:00Z', 'created_at' => '2026-02-25T10:00:00Z' ],
        ],
        'task_history' => [
