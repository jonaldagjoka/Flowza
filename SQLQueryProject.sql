...
CREATE TABLE users(
  ...
  CHECK (role IN ('admin','teamleader','programmer')),
...
CREATE TABLE project_members(
  ...
  CHECK (role_in_project IN ('teamleader','programmer')),
...
CREATE TABLE task(
  ...
  status VARCHAR(20) DEFAULT 'new'
  CHECK (status IN ('new','in progress','review','done')),
...
CREATE TABLE task_history(
  ...
  CHECK (old_status IN ('new','in progress','review','done')),

  new_status VARCHAR(20)
  CHECK (new_status IN ('new','in progress','review','done')),
...
---------------------------
-- TRIGGER: 1 TEAMLEADER PER PROJECT
---------------------------
